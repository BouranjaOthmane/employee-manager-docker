                ...
                <div class="col-md-10">
                    <div class="input-group">
                        <input type="text" name="q" class="form-control"
                               placeholder="Rechercher par date, nom, motif..."
                               value="{{ request('q') }}">
...
<div class="card card-outline card-secondary">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-calendar-day mr-1"></i> Liste des jours fériés</h3>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover table-striped mb-0">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-muted py-4">Aucun jour férié trouvé.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
